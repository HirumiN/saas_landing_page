    ...
    <section>
      <Element name="pricing">
        <div className="container">
          <div className="relative pb-40 mx-auto border-l border-r pricing-head_before border-s2 bg-s1/50 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:h5 max-md:pb32 max-md:pt-16 max-w-960">
            ...
            <div className="relative z-4 mx-auto w-[375px] flex rounded-3xl border-[3px] border-s4/25 p-2 bg-s1/50 backdrop-blur-[6px] max-md:w-[310px]">
              <button
